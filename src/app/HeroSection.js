  ...
  return (
    <div className="relative bg-gradient-to-r from-[#F5EFE7] to-[#D8C4B6] text-[#213555] lg:py-32 py-14 text-center">
      ...
      <div className="container mx-auto px-4">
        <h1 className="text-5xl lg:text-6xl font-extrabold mb-[1.8rem] lg:leading-0 leading-[3.5rem]">
          Study <span className="text-[#D8C4B6] border-[0.1rem] px-4 rounded-md bg-[#213555] border-[#213555]">MBBS</span> Abroad
        </h1>
        <p className="text-lg lg:text-xl font-medium mb-8 max-w-6xl mx-auto">
